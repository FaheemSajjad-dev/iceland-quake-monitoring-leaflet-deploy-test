...
MANUAL = {
    ...
    "frontend/src/__tests__/AppInitialRequests.test.jsx": meta("Frontend tests", "Test", "Verifies parallel initial requests and StrictMode stale-request protection.", ["Mocks API functions", "Renders App under StrictMode", "Checks request coordination"], "App polling and cancellation are easy to duplicate under development StrictMode.", "Initial data may be fetched twice or stale responses may overwrite current state."),
